...
import com.example.mvvmandlivedata.retrofit.ApiClient;
import com.example.mvvmandlivedata.retrofit.ApiInterface;
...
public class MyRetrofit {
    ...
    public LiveData<List<Result>> getNewsListRequest(Boolean isScroll){
        System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"+isScroll+page);
        if(isScroll){
            page++;
        }else {
            page = 1;
